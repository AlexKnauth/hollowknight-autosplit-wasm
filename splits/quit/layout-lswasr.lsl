      ...
      <Settings>
        ...
        <CustomSettings>
          <Setting id="splits" type="list">
            <Setting type="string" value="ManualSplit" />
            <Setting type="string" value="TransitionAfterSaveState" />
            <Setting type="string" value="Menu" />
          </Setting>
          <Setting id="splits_0_item" type="string" value="ManualSplit" />
          <Setting id="splits_1_item" type="string" value="TransitionAfterSaveState" />
          <Setting id="splits_2_item" type="string" value="Menu" />
