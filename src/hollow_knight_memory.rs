...
static DEBUG_SAVE_STATE_SCENE_NAMES: [&str; 2] = ["Room_Mender_House", "Room_Sly_Storeroom"];
...
pub static CRYSTAL_PEAK_ENTRY_SCENES: &[&str] = &["Mines_02", "Mines_10"];
...
pub static QUEENS_GARDENS_ENTRY_SCENES: &[&str] = &["Fungus3_34", "Deepnest_43"];
...
impl GameManagerPointers {
    fn new() -> GameManagerPointers {
        GameManagerPointers {
            version_number: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
            ...
            ui_state_vanilla: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "<ui>k__BackingField", "uiState"],
            ),
            ui_state_modded: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "_uiInstance", "uiState"],
            ),
            camera_teleporting: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "<cameraCtrl>k__BackingField", "teleporting"],
            ),
            camera_target_destination: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
                    "<cameraCtrl>k__BackingField",
                    "camTarget",
                    "destination",
                ],
            ),
            accepting_input: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
            ...
            hero_dead: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "<hero_ctrl>k__BackingField", "cState", "dead"],
            ),
            hazard_death: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
            ...
            hazard_respawning: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
            ...
            hero_recoiling: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
            ...
            hero_recoil_frozen: UnityPointer::new(
                "GameManager",
                0,
                &[
                    "_instance",
...
impl PlayerDataPointers {
    fn new() -> PlayerDataPointers {
        PlayerDataPointers {
            ...
            disable_pause: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "disablePause"],
            ),
            health: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "health"]),
            max_health: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "maxHealth"],
            ),
            mpcharge: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "MPCharge"]),
            fireball_level: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "fireballLevel"],
            ),
            quake_level: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "quakeLevel"],
            ),
            scream_level: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "screamLevel"],
            ),
            has_dash: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasDash"]),
            has_shadow_dash: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasShadowDash"],
            ),
            has_wall_jump: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasWalljump"],
            ),
            has_double_jump: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasDoubleJump"],
            ),
            has_super_dash: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasSuperDash"],
            ),
            has_acid_armour: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasAcidArmour"],
            ),
            has_cyclone: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasCyclone"],
            ),
            has_dash_slash: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasDashSlash"],
            ),
            has_upward_slash: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasUpwardSlash"],
            ),
            has_dream_nail: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasDreamNail"],
            ),
            has_dream_gate: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasDreamGate"],
            ),
            dream_nail_upgraded: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "dreamNailUpgraded"],
            ),
            max_health_base: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "maxHealthBase"],
            ),
            heart_pieces: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "heartPieces"],
            ),
            soul_limited: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "soulLimited"],
            ),
            mp_reserve_max: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "MPReserveMax"],
            ),
            vessel_fragments: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "vesselFragments"],
            ),
            at_bench: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "atBench"]),
            // Dreamers
            mask_broken_lurien: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "maskBrokenLurien"],
            ),
            mask_broken_monomon: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "maskBrokenMonomon"],
            ),
            mask_broken_hegemol: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "maskBrokenHegemol"],
            ),
            guardians_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "guardiansDefeated"],
            ),
            lurien_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "lurienDefeated"],
            ),
            monomon_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "monomonDefeated"],
            ),
            hegemol_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hegemolDefeated"],
            ),
            mr_mushroom_state: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mrMushroomState"],
            ),
            // Keys
            has_city_key: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasCityKey"],
            ),
            has_lantern: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasLantern"],
            ),
            simple_keys: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "simpleKeys"],
            ),
            has_sly_key: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasSlykey"],
            ),
            has_white_key: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasWhiteKey"],
            ),
            has_love_key: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasLoveKey"],
            ),
            got_lurker_key: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotLurkerKey"],
            ),
            sly_simple_key: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "slySimpleKey"],
            ),
            has_kings_brand: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasKingsBrand"],
            ),
            has_tram_pass: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasTramPass"],
            ),
            cornifer_at_home: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "corniferAtHome"],
            ),
            #[cfg(debug_assertions)]
            geo: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "geo"]),
            // Nail and Pale Ore
            nail_smith_upgrades: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "nailSmithUpgrades"],
            ),
            ore: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "ore"]),
            // Stags
            stag_position: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "stagPosition"],
            ),
            opened_crossroads: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedCrossroads"],
            ),
            opened_greenpath: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedGreenpath"],
            ),
            opened_fungal_wastes: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedFungalWastes"],
            ),
            opened_ruins1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedRuins1"],
            ),
            opened_ruins2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedRuins2"],
            ),
            opened_resting_grounds: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedRestingGrounds"],
            ),
            opened_hidden_station: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedHiddenStation"],
            ),
            opened_deepnest: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedDeepnest"],
            ),
            opened_royal_gardens: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedRoyalGardens"],
            ),
            opened_stag_nest: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedStagNest"],
            ),
            travelling: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "travelling"],
            ),
            // Relics
            ...
            sold_trinket1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "soldTrinket1"],
            ),
            sold_trinket2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "soldTrinket2"],
            ),
            sold_trinket3: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "soldTrinket3"],
            ),
            sold_trinket4: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "soldTrinket4"],
            ),
            rancid_eggs: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "rancidEggs"],
            ),
            jinn_eggs_sold: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "jinnEggsSold"],
            ),
            ghost_coins: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "ghostCoins"],
            ),
            // Charm Notches
            notch_shroom_ogres: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "notchShroomOgres"],
            ),
            salubra_notch1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "salubraNotch1"],
            ),
            salubra_notch2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "salubraNotch2"],
            ),
            salubra_notch3: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "salubraNotch3"],
            ),
            salubra_notch4: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "salubraNotch4"],
            ),
            notch_fog_canyon: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "notchFogCanyon"],
            ),
            got_grimm_notch: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotGrimmNotch"],
            ),
            charm_slots: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "charmSlots"],
            ),
            can_overcharm: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "canOvercharm"],
            ),
            // Charms
            got_charm_1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_1"],
            ),
            got_charm_2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_2"],
            ),
            got_charm_3: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_3"],
            ),
            got_charm_4: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_4"],
            ),
            got_charm_5: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_5"],
            ),
            equipped_charm_5: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "equippedCharm_5"],
            ),
            got_charm_6: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_6"],
            ),
            got_charm_7: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_7"],
            ),
            equipped_charm_7: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "equippedCharm_7"],
            ),
            got_charm_8: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_8"],
            ),
            got_charm_9: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_9"],
            ),
            got_charm_10: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_10"],
            ),
            got_charm_11: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_11"],
            ),
            got_charm_12: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_12"],
            ),
            got_charm_13: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_13"],
            ),
            got_charm_14: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_14"],
            ),
            got_charm_15: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_15"],
            ),
            got_charm_16: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_16"],
            ),
            got_charm_17: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_17"],
            ),
            equipped_charm_17: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "equippedCharm_17"],
            ),
            got_charm_18: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_18"],
            ),
            got_charm_19: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_19"],
            ),
            got_charm_20: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_20"],
            ),
            got_charm_21: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_21"],
            ),
            got_charm_22: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_22"],
            ),
            got_charm_26: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_26"],
            ),
            got_charm_27: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_27"],
            ),
            got_charm_28: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_28"],
            ),
            equipped_charm_28: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "equippedCharm_28"],
            ),
            got_charm_29: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_29"],
            ),
            got_charm_30: UnityPointer::new(
                "GameManager",
                0,
            ...
            got_charm_32: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_32"],
            ),
            got_charm_33: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_33"],
            ),
            got_charm_34: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_34"],
            ),
            got_charm_35: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_35"],
            ),
            got_charm_37: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_37"],
            ),
            got_charm_38: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_38"],
            ),
            got_charm_39: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_39"],
            ),
            // Fragile / Unbreakable Charms
            got_charm_23: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_23"],
            ),
            got_charm_24: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_24"],
            ),
            got_charm_25: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_25"],
            ),
            broken_charm_23: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "brokenCharm_23"],
            ),
            broken_charm_24: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "brokenCharm_24"],
            ),
            broken_charm_25: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "brokenCharm_23"],
            ),
            fragile_greed_unbreakable: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "fragileGreed_unbreakable"],
            ),
            fragile_health_unbreakable: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "fragileHealth_unbreakable"],
            ),
            fragile_strength_unbreakable: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "fragileStrength_unbreakable"],
            ),
            // Grimmchild / Carefree Melody
            got_charm_40: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotCharm_40"],
            ),
            equipped_charm_40: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "equippedCharm_40"],
            ),
            grimm_child_level: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "grimmChildLevel"],
            ),
            flames_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "flamesCollected"],
            ),
            got_brumms_flame: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotBrummsFlame"],
            ),
            // Kingsoul / VoidHeart
            charm_cost_36: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "charmCost_36"],
            ),
            got_queen_fragment: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotQueenFragment"],
            ),
            got_king_fragment: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotKingFragment"],
            ),
            royal_charm_state: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "royalCharmState"],
            ),
            got_shade_charm: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gotShadeCharm"],
            ),
            grubs_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "grubsCollected"],
            ),
            scenes_grub_rescued: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "scenesGrubRescued"],
            ),
            kills_grub_mimic: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsGrubMimic"],
            ),
            dream_orbs: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "dreamOrbs"],
            ),
            scenes_encountered_dream_plant_c: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "scenesEncounteredDreamPlantC"],
            ),
            dream_gate_scene: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "dreamGateScene"],
            ),
            dream_gate_x: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "dreamGateX"],
            ),
            dream_gate_y: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "dreamGateY"],
            ),
            map_dirtmouth: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapDirtmouth"],
            ),
            map_crossroads: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapCrossroads"],
            ),
            map_greenpath: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapGreenpath"],
            ),
            map_fog_canyon: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapFogCanyon"],
            ),
            map_royal_gardens: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapRoyalGardens"],
            ),
            map_fungal_wastes: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapFungalWastes"],
            ),
            map_city: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "mapCity"]),
            map_waterways: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapWaterways"],
            ),
            map_mines: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapMines"],
            ),
            map_deepnest: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapDeepnest"],
            ),
            map_cliffs: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapCliffs"],
            ),
            map_outskirts: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapOutskirts"],
            ),
            map_resting_grounds: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapRestingGrounds"],
            ),
            map_abyss: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mapAbyss"],
            ),
            visited_dirtmouth: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedDirtmouth"],
            ),
            sly_shell_frag1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "slyShellFrag1"],
            ),
            sly_shell_frag4: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "slyShellFrag4"],
            ),
            sly_vessel_frag1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "slyVesselFrag1"],
            ),
            sly_vessel_frag2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "slyVesselFrag2"],
            ),
            elderbug_gave_flower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "elderbugGaveFlower"],
            ),
            killed_grimm: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGrimm"],
            ),
            killed_nightmare_grimm: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedNightmareGrimm"],
            ),
            killed_grey_prince: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGreyPrince"],
            ),
            grey_prince_orbs_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "greyPrinceOrbsCollected"],
            ),
            grey_prince_defeats: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "greyPrinceDefeats"],
            ),
            visited_crossroads: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedCrossroads"],
            ),
            crossroads_infected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "crossroadsInfected"],
            ),
            killed_mender_bug: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMenderBug"],
            ),
            killed_mawlek: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMawlek"],
            ),
            killed_big_fly: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedBigFly"],
            ),
            sly_rescued: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "slyRescued"],
            ),
            killed_false_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedFalseKnight"],
            ),
            false_knight_dream_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "falseKnightDreamDefeated"],
            ),
            false_knight_orbs_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "falseKnightOrbsCollected"],
            ),
            kills_prayer_slug: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsPrayerSlug"],
            ),
            kills_roller: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsRoller"],
            ),
            salubra_blessing: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "salubraBlessing"],
            ),
            unchained_hollow_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "unchainedHollowKnight"],
            ),
            killed_hollow_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedHollowKnight"],
            ),
            killed_final_boss: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedFinalBoss"],
            ),
            visited_greenpath: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedGreenpath"],
            ),
            killed_moss_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMossKnight"],
            ),
            zote_rescued_buzzer: UnityPointer::new(
                "GameManager",
                0,
            ...
            killed_lazy_flyer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedLazyFlyer"],
            ),
            killed_hunter_mark: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedHunterMark"],
            ),
            killed_ghost_no_eyes: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostNoEyes"],
            ),
            no_eyes_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "noEyesDefeated"],
            ),
            mega_moss_charger_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "megaMossChargerDefeated"],
            ),
            nailsmith_convo_art: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "nailsmithConvoArt"],
            ),
            visited_fungus: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedFungus"],
            ),
            kills_mushroom_brawler: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsMushroomBrawler"],
            ),
            killed_ghost_hu: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostHu"],
            ),
            elder_hu_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "elderHuDefeated"],
            ),
            bretta_rescued: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "brettaRescued"],
            ),
            defeated_mantis_lords: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "defeatedMantisLords"],
            ),
            // Gorb
            killed_ghost_aladar: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostAladar"],
            ),
            aladar_slug_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "aladarSlugDefeated"],
            ),
            nightmare_lantern_lit: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "nightmareLanternLit"],
            ),
            destroyed_nightmare_lantern: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "destroyedNightmareLantern"],
            ),
            visited_resting_grounds: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedRestingGrounds"],
            ),
            killed_ghost_xero: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostXero"],
            ),
            xero_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "xeroDefeated"],
            ),
            glade_door_opened: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "gladeDoorOpened"],
            ),
            moth_departed: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mothDeparted"],
            ),
            met_xun: UnityPointer::new("GameManager", 0, &["_instance", "playerData", "metXun"]),
            has_xun_flower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasXunFlower"],
            ),
            xun_reward_given: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "xunRewardGiven"],
            ),
            opened_city_gate: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedCityGate"],
            ),
            visited_ruins: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedRuins"],
            ),
            killed_gorgeous_husk: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGorgeousHusk"],
            ),
            met_relic_dealer_shop: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "metRelicDealerShop"],
            ),
            toll_bench_city: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "tollBenchCity"],
            ),
            killed_mage: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMage"],
            ),
            killed_mage_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMageKnight"],
            ),
            mage_lord_encountered: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mageLordEncountered"],
            ),
            mage_lord_encountered_2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mageLordEncountered_2"],
            ),
            killed_mage_lord: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMageLord"],
            ),
            mage_lord_dream_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mageLordDreamDefeated"],
            ),
            mage_lord_orbs_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mageLordOrbsCollected"],
            ),
            killed_great_shield_zombie: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGreatShieldZombie"],
            ),
            kills_great_shield_zombie: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsGreatShieldZombie"],
            ),
            watcher_chandelier: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "watcherChandelier"],
            ),
            killed_black_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedBlackKnight"],
            ),
            collector_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "collectorDefeated"],
            ),
            nailsmith_killed: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "nailsmithKilled"],
            ),
            nailsmith_spared: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "nailsmithSpared"],
            ),
            visited_mines: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedMines"],
            ),
            kills_zombie_miner: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsZombieMiner"],
            ),
            defeated_mega_beam_miner: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "defeatedMegaBeamMiner"],
            ),
            kills_mega_beam_miner: UnityPointer::new(
                "GameManager",
                0,
            ...
            mine_lift_opened: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mineLiftOpened"],
            ),
            opened_waterways_manhole: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedWaterwaysManhole"],
            ),
            visited_waterways: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedWaterways"],
            ),
            killed_dung_defender: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedDungDefender"],
            ),
            killed_white_defender: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedWhiteDefender"],
            ),
            white_defender_orbs_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "whiteDefenderOrbsCollected"],
            ),
            white_defender_defeats: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "whiteDefenderDefeats"],
            ),
            dung_defender_awake_convo: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "dungDefenderAwakeConvo"],
            ),
            met_emilitia: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "metEmilitia"],
            ),
            given_emilitia_flower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "givenEmilitiaFlower"],
            ),
            killed_fluke_mother: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedFlukeMother"],
            ),
            visited_abyss: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedAbyss"],
            ),
            saved_cloth: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "savedCloth"],
            ),
            toll_bench_abyss: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "tollBenchAbyss"],
            ),
            killed_infected_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedInfectedKnight"],
            ),
            infected_knight_dream_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "infectedKnightDreamDefeated"],
            ),
            infected_knight_orbs_collected: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "infectedKnightOrbsCollected"],
            ),
            abyss_gate_opened: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "abyssGateOpened"],
            ),
            abyss_lighthouse: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "abyssLighthouse"],
            ),
            visited_white_palace: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedWhitePalace"],
            ),
            white_palace_orb_1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "whitePalaceOrb_1"],
            ),
            white_palace_orb_2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "whitePalaceOrb_2"],
            ),
            white_palace_orb_3: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "whitePalaceOrb_3"],
            ),
            new_data_binding_seal: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "newDataBindingSeal"],
            ),
            white_palace_secret_room_visited: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "whitePalaceSecretRoomVisited"],
            ),
            visited_outskirts: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedOutskirts"],
            ),
            visited_hive: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedHive"],
            ),
            killed_hive_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedHiveKnight"],
            ),
            killed_giant_hopper: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGiantHopper"],
            ),
            given_oro_flower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "givenOroFlower"],
            ),
            hornet_outskirts_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hornetOutskirtsDefeated"],
            ),
            killed_ghost_markoth: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostMarkoth"],
            ),
            markoth_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "markothDefeated"],
            ),
            little_fool_met: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "littleFoolMet"],
            ),
            colosseum_bronze_opened: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "colosseumBronzeOpened"],
            ),
            seen_colosseum_title: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "seenColosseumTitle"],
            ),
            kills_col_shield: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColShield"],
            ),
            kills_col_roller: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColRoller"],
            ),
            kills_col_miner: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColMiner"],
            ),
            kills_spitter: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsSpitter"],
            ),
            kills_super_spitter: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsSuperSpitter"],
            ),
            kills_buzzer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsBuzzer"],
            ),
            kills_big_buzzer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsBigBuzzer"],
            ),
            kills_bursting_bouncer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsBurstingBouncer"],
            ),
            kills_big_fly: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsBigFly"],
            ),
            killed_zote: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedZote"],
            ),
            colosseum_bronze_completed: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "colosseumBronzeCompleted"],
            ),
            colosseum_silver_opened: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "colosseumSilverOpened"],
            ),
            kills_col_worm: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColWorm"],
            ),
            kills_col_flying_sentry: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColFlyingSentry"],
            ),
            kills_col_mosquito: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColMosquito"],
            ),
            kills_ceiling_dropper: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsCeilingDropper"],
            ),
            kills_giant_hopper: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsGiantHopper"],
            ),
            kills_blobble: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsBlobble"],
            ),
            kills_oblobble: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsOblobble"],
            ),
            colosseum_silver_completed: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "colosseumSilverCompleted"],
            ),
            colosseum_gold_opened: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "colosseumGoldOpened"],
            ),
            kills_angry_buzzer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsAngryBuzzer"],
            ),
            kills_col_hopper: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsColHopper"],
            ),
            kills_heavy_mantis: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsHeavyMantis"],
            ),
            kills_mantis_heavy_flyer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsMantisHeavyFlyer"],
            ),
            kills_mage_knight: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsMageKnight"],
            ),
            kills_electric_mage: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsElectricMage"],
            ),
            kills_mage: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsMage"],
            ),
            kills_lesser_mawlek: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsLesserMawlek"],
            ),
            kills_mawlek: UnityPointer::new(
                "GameManager",
                0,
            ...
            kills_lobster_lancer: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killsLobsterLancer"],
            ),
            colosseum_gold_completed: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "colosseumGoldCompleted"],
            ),
            visited_fog_canyon: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedFogCanyon"],
            ),
            encountered_mega_jelly: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "encounteredMegaJelly"],
            ),
            killed_mega_jellyfish: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMegaJellyfish"],
            ),
            visited_royal_gardens: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedRoyalGardens"],
            ),
            toll_bench_queens_gardens: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "tollBenchQueensGardens"],
            ),
            xun_flower_given: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "xunFlowerGiven"],
            ),
            killed_ghost_marmu: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostMarmu"],
            ),
            mum_caterpillar_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "mumCaterpillarDefeated"],
            ),
            killed_traitor_lord: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedTraitorLord"],
            ),
            given_white_lady_flower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "givenWhiteLadyFlower"],
            ),
            visited_deepnest: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedDeepnest"],
            ),
            visited_deepnest_spa: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedDeepnestSpa"],
            ),
            zote_rescued_deepnest: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "zoteRescuedDeepnest"],
            ),
            opened_tram_lower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "openedTramLower"],
            ),
            killed_mimic_spider: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedMimicSpider"],
            ),
            killed_ghost_galien: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedGhostGalien"],
            ),
            galien_defeated: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "galienDefeated"],
            ),
            spider_capture: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "spiderCapture"],
            ),
            has_godfinder: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "hasGodfinder"],
            ),
            given_godseeker_flower: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "givenGodseekerFlower"],
            ),
            visited_godhome: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "visitedGodhome"],
            ),
            zote_statue_wall_broken: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "zoteStatueWallBroken"],
            ),
            ordeal_achieved: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "ordealAchieved"],
            ),
            killed_nail_bros: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedNailBros"],
            ),
            killed_paintmaster: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedPaintmaster"],
            ),
            killed_nailsage: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedNailsage"],
            ),
            killed_hollow_knight_prime: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "killedHollowKnightPrime"],
            ),
        }
    }
}
...
impl CompletionPointers {
    fn new() -> CompletionPointers {
        CompletionPointers {
            boss_door_state_tier1: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "bossDoorStateTier1"],
            ),
            boss_door_state_tier2: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "bossDoorStateTier2"],
            ),
            boss_door_state_tier3: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "bossDoorStateTier3"],
            ),
            boss_door_state_tier4: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "playerData", "bossDoorStateTier4"],
            ),
            boss_door_state_tier5: UnityPointer::new(
                "GameManager",
                0,
...
impl SceneDataPointers {
    fn new() -> SceneDataPointers {
        SceneDataPointers {
            persistent_bool_items: UnityPointer::new(
                "GameManager",
                0,
                &["_instance", "sceneData", "persistentBoolItems"],
            ),
...
impl GameManagerFinder {
    ...
    fn deref_pointer<const PN: usize>(
        &self,
        process: &Process,
        pointer: &UnityPointer<PN>,
    ) -> Result<Address, asr::Error> {
        match self.string_list_offests.pointer_size {
            PointerSize::Bit64 => Ok(pointer
                .deref::<Address64>(process, &self.module, &self.image)?
                .into()),
            PointerSize::Bit32 => Ok(pointer
                .deref::<Address32>(process, &self.module, &self.image)?
                .into()),
            PointerSize::Bit16 => Ok(pointer
                .deref::<Address16>(process, &self.module, &self.image)?
                .into()),
        }
    }
    ...
    pub fn get_scene_name(&self, process: &Process) -> Option<String> {
        let s = self
            .deref_pointer(process, &self.pointers.scene_name)
            .ok()?;
    ...
    pub fn get_next_scene_name(&self, process: &Process) -> Option<String> {
        let s = self
            .deref_pointer(process, &self.pointers.next_scene_name)
            .ok()?;
        read_string_object(process, &self.string_list_offests, s)
    }
    ...
    pub fn get_entry_gate_name(&self, process: &Process) -> Option<String> {
        let s = self
            .deref_pointer(process, &self.pointers.entry_gate_name)
            .ok()?;
        read_string_object(process, &self.string_list_offests, s)
    }
    ...
    fn is_game_state_non_menu(&self, process: &Process) -> bool {
        self.get_game_state(process)
            .is_some_and(|gs| NON_MENU_GAME_STATES.contains(&gs))
    }

    fn is_game_state_non_continuous(&self, process: &Process) -> bool {
        self.get_game_state(process)
            .is_some_and(|gs| NON_CONTINUOUS_GAME_STATES.contains(&gs))
    }
    ...
    pub fn get_ui_state(&self, process: &Process) -> Option<i32> {
        ...
        let ui_state_offset = if let Some(ui_state_offset) = self.ui_state_offset.get() {
            ...
            let ui_state_offset =
                ui_manager_class.get_field_offset(process, &self.module, "uiState")?;
    ...
    pub fn get_version_string(&self, process: &Process) -> Option<String> {
        let s: Address = [
            &self.pointers.version_number,
            &self.player_data_pointers.version,
        ]
        .into_iter()
        .find_map(|ptr| self.deref_pointer(process, ptr).ok())?;
        read_string_object(process, &self.string_list_offests, s)
    }

    pub fn get_version_vec(&self, process: &Process) -> Option<Vec<i32>> {
        Some(
            self.get_version_string(process)?
                .split('.')
    ...
    pub fn scenes_grub_rescued(&self, process: &Process) -> Option<Vec<String>> {
        let l = self
            .deref_pointer(process, &self.player_data_pointers.scenes_grub_rescued)
            .ok()?;
    ...
    pub fn grub_waterways_isma(&self, process: &Process) -> Option<bool> {
        Some(
            self.scenes_grub_rescued(process)?
                .contains(&"Waterways_13".to_string()),
        )
    }
    ...
    pub fn scenes_encountered_dream_plant_c(&self, process: &Process) -> Option<Vec<String>> {
        let l = self
            .deref_pointer(
                process,
                &self.player_data_pointers.scenes_encountered_dream_plant_c,
            )
            .ok()?;
        read_string_list_object(process, &self.string_list_offests, l)
    }
    ...
    pub fn dream_gate_scene(&self, process: &Process) -> Option<String> {
        let s = self
            .deref_pointer(process, &self.player_data_pointers.dream_gate_scene)
            .ok()?;
        read_string_object(process, &self.string_list_offests, s)
    }
    ...
    pub fn infected_knight_dream_defeated(&self, process: &Process) -> Option<bool> {
        self.player_data_pointers
            .infected_knight_dream_defeated
            .deref(process, &self.module, &self.image)
            .ok()
    }
    ...
    pub fn infected_knight_orbs_collected(&self, process: &Process) -> Option<bool> {
        self.player_data_pointers
            .infected_knight_orbs_collected
            .deref(process, &self.module, &self.image)
            .ok()
    }
    ...
    pub fn white_palace_secret_room_visited(&self, process: &Process) -> Option<bool> {
        self.player_data_pointers
            .white_palace_secret_room_visited
            .deref(process, &self.module, &self.image)
            .ok()
    }
    ...
    pub fn boss_door_state_tier1(&self, process: &Process) -> Option<BossSequenceDoorCompletion> {
        self.completion_pointers
            .boss_door_state_tier1
            .deref(process, &self.module, &self.image)
            .ok()
    }
...
impl SceneStore {
    ...
    pub fn new_curr_scene_name1(&mut self, msn: Option<String>) -> bool {
        match msn {
            None => false,
            Some(bad) if BAD_SCENE_NAMES.contains(&bad.as_str()) => true,
            Some(sn) => {
...
impl PlayerDataStore {
    ...
    fn changed_bool<const N: usize>(
        ...
        if player_data_val? == store_val? {
            return None;
        }
        player_data_val
    }

    fn get_i32<const N: usize>(
        &mut self,
        p: &Process,
        g: &GameManagerFinder,
        key: &'static str,
    ...
    fn incremented_i32<const N: usize>(
        ...
        self.changed_i32_delta(p, g, key, pointer)
            .is_some_and(|d| d == 1)
    }

    fn increased_i32<const N: usize>(
        &mut self,
        p: &Process,
        g: &GameManagerFinder,
        key: &'static str,
    ...
    fn decremented_i32<const N: usize>(
        &mut self,
        p: &Process,
        g: &GameManagerFinder,
        key: &'static str,
    ...
    pub fn obtained_mask_shard(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.incremented_i32(
            p,
            g,
            "max_health_base",
            &g.player_data_pointers.max_health_base,
    ...
    pub fn shade_killed(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.changed_bool(p, g, "soul_limited", &g.player_data_pointers.soul_limited)
            .is_some_and(|l| !l)
    }
    ...
    pub fn obtained_vessel_fragment(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.increased_i32(
            ...
            g,
            "mp_reserve_max",
            &g.player_data_pointers.mp_reserve_max,
        ) || (self.incremented_i32(
            p,
            g,
            "vessel_fragments",
            &g.player_data_pointers.vessel_fragments,
    ...
    pub fn get_fireball_level(&mut self, p: &Process, g: &GameManagerFinder) -> i32 {
        self.get_i32(
            ...
            g,
            "fireball_level",
            &g.player_data_pointers.fireball_level,
        )
        .unwrap_or(0)
    }

    pub fn get_quake_level(&mut self, p: &Process, g: &GameManagerFinder) -> i32 {
        self.get_i32(p, g, "quake_level", &g.player_data_pointers.quake_level)
            .unwrap_or(0)
    }

    pub fn has_dash(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(p, g, "has_dash", &g.player_data_pointers.has_dash)
            .unwrap_or(false)
    }

    pub fn has_wall_jump(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(p, g, "has_wall_jump", &g.player_data_pointers.has_wall_jump)
            .unwrap_or(false)
    }
    ...
    pub fn has_double_jump(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "has_double_jump",
            &g.player_data_pointers.has_double_jump,
        )
        .unwrap_or(false)
    }
    ...
    pub fn has_acid_armour(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "has_acid_armour",
            &g.player_data_pointers.has_acid_armour,
        )
        .unwrap_or(false)
    }
    ...
    pub fn has_dream_nail(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "has_dream_nail",
            &g.player_data_pointers.has_dream_nail,
        )
        .unwrap_or(false)
    }
    ...
    pub fn has_dream_gate(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "has_dream_gate",
            &g.player_data_pointers.has_dream_gate,
        )
        .unwrap_or(false)
    }

    pub fn has_lantern(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(p, g, "has_lantern", &g.player_data_pointers.has_lantern)
            .unwrap_or(false)
    }
    ...
    pub fn cornifer_at_home(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "cornifer_at_home",
            &g.player_data_pointers.cornifer_at_home,
        )
        .unwrap_or(false)
    }
    ...
    pub fn flames_collected(&mut self, p: &Process, g: &GameManagerFinder) -> i32 {
        self.get_i32(
            ...
            g,
            "flames_collected",
            &g.player_data_pointers.flames_collected,
        )
        .unwrap_or(0)
    }
    ...
    pub fn got_shade_charm(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "got_shade_charm",
            &g.player_data_pointers.got_shade_charm,
        )
        .unwrap_or(false)
    }

    pub fn incremented_grubs_collected(
        &mut self,
        process: &Process,
        ...
        self.incremented_i32(
            ...
            game_manager_finder,
            "grubs_collected",
            &game_manager_finder.player_data_pointers.grubs_collected,
        )
    }
    ...
    pub fn incremented_ore(
        ...
        self.incremented_i32(
            ...
            game_manager_finder,
            "ore",
            &game_manager_finder.player_data_pointers.ore,
        )
    }

    pub fn changed_travelling_true(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.changed_bool(
            ...
            game_manager_finder,
            "travelling",
            &game_manager_finder.player_data_pointers.travelling,
        )
        .is_some_and(|t| t)
    }

    pub fn changed_stag_position(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.changed_i32_delta(
            process,
            game_manager_finder,
            "stag_position",
            &game_manager_finder.player_data_pointers.stag_position,
        )
        .is_some_and(|d| d != 0)
    }

    pub fn incremented_simple_keys(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "simple_keys",
            &game_manager_finder.player_data_pointers.simple_keys,
        )
    }

    pub fn decremented_simple_keys(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.decremented_i32(
            process,
            game_manager_finder,
            "simple_keys",
            &game_manager_finder.player_data_pointers.simple_keys,
    ...
    pub fn incremented_trinket1(
        ...
        self.incremented_i32(
            ...
            game_manager_finder,
            "trinket1",
            &game_manager_finder.player_data_pointers.trinket1,
        )
    }

    pub fn incremented_trinket2(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "trinket2",
            &game_manager_finder.player_data_pointers.trinket2,
        )
    }

    pub fn incremented_trinket3(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "trinket3",
            &game_manager_finder.player_data_pointers.trinket3,
        )
    }

    pub fn incremented_trinket4(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "trinket4",
            &game_manager_finder.player_data_pointers.trinket4,
        )
    }

    pub fn incremented_rancid_eggs(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "rancid_eggs",
            &game_manager_finder.player_data_pointers.rancid_eggs,
        )
    }

    pub fn incremented_ghost_coins(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "ghost_coins",
            &game_manager_finder.player_data_pointers.ghost_coins,
        )
    }

    pub fn incremented_charm_slots(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "charm_slots",
            &game_manager_finder.player_data_pointers.charm_slots,
        )
    }

    pub fn can_overcharm(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(p, g, "can_overcharm", &g.player_data_pointers.can_overcharm)
            .unwrap_or(false)
    }

    pub fn incremented_dream_orbs(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "dream_orbs",
            &game_manager_finder.player_data_pointers.dream_orbs,
        )
    }

    pub fn glade_essence_since_changed(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
        changed: bool,
        ...
        let glade_essence_since_changed = if changed {
            ...
            0
        } else if let Some(&glade_essence_since_changed) =
            self.map_i32.get("glade_essence_since_changed")
        {
        ...
        if o && game_manager_finder
            .get_scene_name(process)
            .is_some_and(|s| s.starts_with("RestingGrounds_08"))
        {
            let next_glade_essence = glade_essence_since_changed + 1;
            self.map_i32
                .insert("glade_essence_since_changed", next_glade_essence);
            next_glade_essence
        } else {
            glade_essence_since_changed
        }
    ...
    pub fn incremented_grey_prince_defeats(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.incremented_i32(
            ...
            game_manager_finder,
            "grey_prince_defeats",
            &game_manager_finder.player_data_pointers.grey_prince_defeats,
        )
    }

    pub fn incremented_white_defender_defeats(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
    ...
    pub fn dung_defender_awake_convo_on_entry(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
    ) -> bool {
        ...
        match self.map_bool.get("dung_defender_awake_convo_on_entry") {
            None => {
                if let Ok(convo_now) = gmf.player_data_pointers.dung_defender_awake_convo.deref(
                    prc,
                    &gmf.module,
                    &gmf.image,
                ) {
                    self.map_bool
                        .insert("dung_defender_awake_convo_on_entry", convo_now);
                    convo_now
                } else {
                    false
                }
    ...
    pub fn zote_rescued_buzzer(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "zote_rescued_buzzer",
            &g.player_data_pointers.zote_rescued_buzzer,
        )
        .unwrap_or(false)
    }
    ...
    pub fn mega_moss_charger_defeated(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "mega_moss_charger_defeated",
            &g.player_data_pointers.mega_moss_charger_defeated,
        )
        .unwrap_or(false)
    }
    ...
    pub fn unchained_hollow_knight(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            p,
            g,
            "unchained_hollow_knight",
            &g.player_data_pointers.unchained_hollow_knight,
        )
        .unwrap_or(false)
    }
    ...
    pub fn killed_big_fly(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "killed_big_fly",
            &g.player_data_pointers.killed_big_fly,
        )
        .unwrap_or(false)
    }
    ...
    pub fn killed_ghost_hu(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "killed_ghost_hu",
            &g.player_data_pointers.killed_ghost_hu,
        )
        .unwrap_or(false)
    }
    ...
    pub fn killed_gorgeous_husk(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            p,
            g,
            "killed_gorgeous_husk",
            &g.player_data_pointers.killed_gorgeous_husk,
        )
        .unwrap_or(false)
    }
    ...
    pub fn killed_black_knight(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "killed_black_knight",
            &g.player_data_pointers.killed_black_knight,
        )
        .unwrap_or(false)
    }
    ...
    pub fn collector_defeated(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "collector_defeated",
            &g.player_data_pointers.collector_defeated,
        )
        .unwrap_or(false)
    }
    ...
    pub fn killed_infected_knight(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "killed_infected_knight",
            &g.player_data_pointers.killed_infected_knight,
        )
        .unwrap_or(false)
    }

    pub fn decremented_kills_zombie_miner(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.decremented_i32(
            ...
            game_manager_finder,
            "kills_zombie_miner",
            &game_manager_finder.player_data_pointers.kills_zombie_miner,
        )
    }
    ...
    pub fn colosseum_bronze_completed(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "colosseum_bronze_completed",
            &g.player_data_pointers.colosseum_bronze_completed,
        )
        .unwrap_or(false)
    }
    ...
    pub fn colosseum_silver_completed(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "colosseum_silver_completed",
            &g.player_data_pointers.colosseum_silver_completed,
        )
        .unwrap_or(false)
    }
    ...
    pub fn colosseum_gold_completed(&mut self, p: &Process, g: &GameManagerFinder) -> bool {
        self.get_bool(
            ...
            g,
            "colosseum_gold_completed",
            &g.player_data_pointers.colosseum_gold_completed,
        )
        .unwrap_or(false)
    }

    pub fn increased_royal_charm_state(
        &mut self,
        process: &Process,
        game_manager_finder: &GameManagerFinder,
    ) -> bool {
        self.increased_i32(
            ...
            game_manager_finder,
            "royal_charm_state",
            &game_manager_finder.player_data_pointers.royal_charm_state,
        )
    }

    fn been_dead_for_a_tick<const N: usize>(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
        key: &'static str,
    ...
    pub fn traitor_lord_been_dead_for_a_tick(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
    ) -> bool {
        self.been_dead_for_a_tick(
            prc,
            gmf,
            "killed_traitor_lord",
            &gmf.player_data_pointers.killed_traitor_lord,
        )
    }

    pub fn hive_knight_been_dead_for_a_tick(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
    ) -> bool {
        gmf.hive_knight_doesnt_exist(prc).is_some_and(|d| d)
            || self.been_dead_for_a_tick(
                ...
                gmf,
                "killed_hive_knight",
                &gmf.player_data_pointers.killed_hive_knight,
            )
    }

    fn kills_on_entry<const N: usize>(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
        key: &'static str,
    ...
    fn kills_decreased_by<const N: usize>(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
        key: &'static str,
    ...
    pub fn aspid_hunter_arena(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_spitter_on_entry",
            &gmf.player_data_pointers.kills_spitter,
            3,
        )
    }

    pub fn mushroom_brawler_arena(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
    ) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_mushroom_brawler_on_entry",
            &gmf.player_data_pointers.kills_mushroom_brawler,
            2,
        )
    }
    ...
    pub fn bronze1a(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_col_shield_on_entry",
            &gmf.player_data_pointers.kills_col_shield,
            1,
        )
    }
    ...
    pub fn bronze1c(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_col_roller_on_entry",
            &gmf.player_data_pointers.kills_col_roller,
            2,
        )
    }
    ...
    pub fn bronze3a(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_col_miner_on_entry",
            &gmf.player_data_pointers.kills_col_miner,
            1,
        )
    }
    ...
    pub fn bronze8a(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_buzzer_on_entry",
            &gmf.player_data_pointers.kills_buzzer,
            4,
        )
    }
    pub fn bronze8b(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_big_buzzer_on_entry",
            &gmf.player_data_pointers.kills_big_buzzer,
            1,
        )
    }
    ...
    pub fn bronze11a(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_bursting_bouncer_on_entry",
            &gmf.player_data_pointers.kills_bursting_bouncer,
            2,
        )
    }
    ...
    pub fn bronze_end(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_big_fly_on_entry",
            &gmf.player_data_pointers.kills_big_fly,
            2,
        )
    }
    pub fn silver1(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            prc,
            gmf,
            "kills_col_worm_on_entry",
            &gmf.player_data_pointers.kills_col_worm,
        );
        self.kills_on_entry(
            prc,
            gmf,
            "kills_col_flying_sentry_on_entry",
            &gmf.player_data_pointers.kills_col_flying_sentry,
        );
        // Heavy Fool: {0} +2 {2}
        // Winged Fool: {0} +3 {3}
        Some(
    ...
    pub fn silver2(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_col_mosquito_on_entry",
            &gmf.player_data_pointers.kills_col_mosquito,
            2,
        )
    }
    ...
    pub fn silver5(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            prc,
            gmf,
            "kills_super_spitter_on_entry",
            &gmf.player_data_pointers.kills_super_spitter,
        );
        // Squit: {5} +2 {7}
    ...
    pub fn silver6(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            prc,
            gmf,
            "kills_ceiling_dropper_on_entry",
            &gmf.player_data_pointers.kills_ceiling_dropper,
        );
        // Heavy Fool: {2} +1 {3}
        // Belfly: {0} +3 {3}
        Some(
    ...
    pub fn silver8(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_giant_hopper_on_entry",
            &gmf.player_data_pointers.kills_giant_hopper,
            1,
        )
    }
    ...
    pub fn silver10(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_grub_mimic_on_entry",
            &gmf.player_data_pointers.kills_grub_mimic,
            1,
        )
    }
    ...
    pub fn silver15(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_blobble_on_entry",
            &gmf.player_data_pointers.kills_blobble,
            9,
        )
    }
    ...
    pub fn silver_end(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_oblobble_on_entry",
            &gmf.player_data_pointers.kills_oblobble,
            2,
        )
    }
    ...
    pub fn gold3(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_on_entry(
            prc,
            gmf,
            "kills_angry_buzzer_on_entry",
            &gmf.player_data_pointers.kills_angry_buzzer,
        );
        // Obble: {0} +3 {3}
        // Winged Fool: {2} +1 {3}
    ...
    pub fn gold5(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_col_hopper_on_entry",
            &gmf.player_data_pointers.kills_col_hopper,
            3,
        )
    }
    ...
    pub fn gold9a(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            prc,
            gmf,
            "kills_heavy_mantis_on_entry",
            &gmf.player_data_pointers.kills_heavy_mantis,
        );
        self.kills_on_entry(
            prc,
            gmf,
    ...
    pub fn gold9b(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            ...
            gmf,
            "kills_mage_on_entry",
            &gmf.player_data_pointers.kills_mage,
        );
        // Soul Twister: {0} +2 {2}
        // Soul Warrior: {0} +1 {1}
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_mage_knight_on_entry",
            &gmf.player_data_pointers.kills_mage_knight,
            1,
        )
    }
    pub fn gold10(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            prc,
            gmf,
            "kills_electric_mage_on_entry",
            &gmf.player_data_pointers.kills_electric_mage,
        );
        self.kills_on_entry(
            prc,
            gmf,
    ...
    pub fn gold12a(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        self.kills_on_entry(
            prc,
            gmf,
            "kills_lesser_mawlek_on_entry",
            &gmf.player_data_pointers.kills_lesser_mawlek,
        );
        // Winged Fool: {5} +2 {7}
        // Sturdy Fool: {3} +1 {4}
        // Lesser Mawlek: {0} +4 {4}
    ...
    pub fn gold12b(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_mawlek_on_entry",
            &gmf.player_data_pointers.kills_mawlek,
            1,
        )
    }
    ...
    pub fn gold_end(&mut self, prc: &Process, gmf: &GameManagerFinder) -> Option<bool> {
        ...
        self.kills_decreased_by(
            prc,
            gmf,
            "kills_lobster_lancer_on_entry",
            &gmf.player_data_pointers.kills_lobster_lancer,
            1,
        )
    }

    pub fn obtained_all_skills_shuffle_item(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
    ) -> bool {
        if self
            .changed_bool(prc, gmf, "has_dash", &gmf.player_data_pointers.has_dash)
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_shadow_dash",
                &gmf.player_data_pointers.has_shadow_dash,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_wall_jump",
                &gmf.player_data_pointers.has_wall_jump,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_double_jump",
                &gmf.player_data_pointers.has_double_jump,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_super_dash",
                &gmf.player_data_pointers.has_super_dash,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_acid_armour",
                &gmf.player_data_pointers.has_acid_armour,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_cyclone",
                &gmf.player_data_pointers.has_cyclone,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_dash_slash",
                &gmf.player_data_pointers.has_dash_slash,
            )
            .is_some_and(|h| h)
        {
            ...
            .changed_bool(
                ...
                gmf,
                "has_upward_slash",
                &gmf.player_data_pointers.has_upward_slash,
            )
            .is_some_and(|h| h)
        {
            ...
            true
        } else if let Some(p) = self.changed_i32(
            prc,
            gmf,
            "fireball_level",
            &gmf.player_data_pointers.fireball_level,
        ) {
            match p {
                ...
                Pair {
                    old: 0 | 1,
                    current: 2,
                } => asr::timer::set_variable("item", "Shade Soul"),
                _ => {
                    return false;
                }
            }
            ...
            gmf,
            "quake_level",
            &gmf.player_data_pointers.quake_level,
        ) {
            match p {
                ...
                Pair {
                    old: 0 | 1,
                    current: 2,
                } => asr::timer::set_variable("item", "DDark"),
                _ => {
                    return false;
                }
            }
            ...
            gmf,
            "scream_level",
            &gmf.player_data_pointers.scream_level,
        ) {
            match p {
                ...
                Pair {
                    old: 0 | 1,
                    current: 2,
                } => asr::timer::set_variable("item", "Shriek"),
                _ => {
                    return false;
                }
            }
            ...
            .changed_bool(
                ...
                gmf,
                "has_dream_nail",
                &gmf.player_data_pointers.has_dream_nail,
            )
            .is_some_and(|h| h)
        {
...
impl SceneDataStore {
    ...
    pub fn glade_ghosts_killed(
        &mut self,
        prc: &Process,
        gmf: &GameManagerFinder,
    ) -> Option<(bool, bool, i32)> {
        let pbis = gmf
            .deref_pointer(prc, &gmf.scene_data_pointers.persistent_bool_items)
            .ok()?;
        let offsets = gmf
            .scene_data_pointers
            .offsets(prc, &gmf.module, &gmf.image)?;
        ...
        for pbi in list_object_iter(prc, &gmf.string_list_offests, pbis)? {
            ...
            let scene_addr = prc
                .read_pointer(
                    pbi + offsets.persistentbooldata_scenename,
                    gmf.string_list_offests.pointer_size,
                )
                .ok()?;
            ...
            let id_addr = prc
                .read_pointer(
                    pbi + offsets.persistentbooldata_id,
                    gmf.string_list_offests.pointer_size,
                )
                .ok()?;
            ...
            if !self
                .map_bool_items
                .get(&key)
                .is_some_and(|&prev_activated| prev_activated == activated)
            {
                changed = true;
                #[cfg(debug_assertions)]
        ...
        if !self
            .map_bool_derived
            .get("revek_alone")
            .is_some_and(|&prev_alone| prev_alone == revek_alone)
        {
            changed = true;
            #[cfg(debug_assertions)]
        ...
        if !self
            .map_i32_derived
            .get("glade_ghosts_killed")
            .is_some_and(|&prev_killed| prev_killed == killed)
        {
            changed = true;
            #[cfg(debug_assertions)]
...
fn read_string_object(
    ...
    let w: Vec<u16> = process
        .read_vec(a + offsets.string_contents, n as usize)
        .ok()?;
...
fn list_object_iter<'a>(
    process: &'a Process,
    offsets: &'a StringListOffsets,
    a: Address,
) -> Option<impl FusedIterator<Item = Address> + 'a> {
    let array_ptr: Address = process
        .read_pointer(a + offsets.list_array, offsets.pointer_size)
        .ok()?;
    ...
    Some(
        (0..(vn as u64))
            .filter_map(move |i| {
                ...
                process
                    .read_pointer(array_ptr + item_offset, offsets.pointer_size)
                    .ok()
            })
            .fuse(),
    )
...
pub fn is_dream(s: &str) -> bool {
    s.starts_with("Dream_") || (s.starts_with("GG_") && !s.contains("way") && !s.contains("Lurker"))
}
