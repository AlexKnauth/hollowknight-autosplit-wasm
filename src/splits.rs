...
pub fn continuous_splits(s: &Split, p: &Process, g: &GameManagerFinder, pds: &mut PlayerDataStore) -> SplitterAction {
    match s {
        ...
        Split::Bronze1a => todo!("Bronze1a"),
        Split::Bronze1b => todo!("Bronze1b"),
        Split::Bronze1c => todo!("Bronze1c"),
        Split::Bronze2 => todo!("Bronze2"),
        Split::Bronze3a => todo!("Bronze3a"),
        Split::Bronze3b => todo!("Bronze3b"),
        Split::Bronze4 => todo!("Bronze4"),
        Split::Bronze5 => todo!("Bronze5"),
        Split::Bronze6 => todo!("Bronze6"),
        Split::Bronze7 => todo!("Bronze7"),
        Split::Bronze8a => todo!("Bronze8a"),
        Split::Bronze8b => todo!("Bronze8b"),
        Split::Bronze9 => todo!("Bronze9"),
        Split::Bronze10 => todo!("Bronze10"),
        Split::Bronze11a => todo!("Bronze11a"),
        Split::Bronze11b => todo!("Bronze11b"),
        Split::BronzeEnd => todo!("BronzeEnd"),
        ...
        Split::Silver1 => todo!("Silver1"),
        Split::Silver2 => todo!("Silver2"),
        Split::Silver3 => todo!("Silver3"),
        Split::Silver4 => todo!("Silver4"),
        Split::Silver5 => todo!("Silver5"),
        Split::Silver6 => todo!("Silver6"),
        Split::Silver7 => todo!("Silver7"),
        Split::Silver8 => todo!("Silver8"),
        Split::Silver9 => todo!("Silver9"),
        Split::Silver10 => todo!("Silver10"),
        Split::Silver11 => todo!("Silver11"),
        Split::Silver12 => todo!("Silver12"),
        Split::Silver13 => todo!("Silver13"),
        Split::Silver14 => todo!("Silver14"),
        Split::Silver15 => todo!("Silver15"),
        Split::Silver16 => todo!("Silver16"),
        Split::SilverEnd => todo!("SilverEnd"),
        ...
        Split::Gold1 => todo!("Gold1"),
        // Wave 2 splits inconsistently since the enemies are killed by the spikes on the floor automatically
        Split::Gold3 => todo!("Gold3"),
        Split::Gold4 => todo!("Gold4"),
        Split::Gold5 => todo!("Gold5"),
        Split::Gold6 => todo!("Gold6"),
        Split::Gold7 => todo!("Gold7"),
        Split::Gold8a => todo!("Gold8a"),
        Split::Gold8 => todo!("Gold8"),
        Split::Gold9a => todo!("Gold9a"),
        Split::Gold9b => todo!("Gold9b"),
        Split::Gold10 => todo!("Gold10"),
        Split::Gold11 => todo!("Gold11"),
        Split::Gold12a => todo!("Gold12a"),
        Split::Gold12b => todo!("Gold12b"),
        // Wave 13 doesn't really exist, it's just vertical Garpedes so there's nothing to Split on
        Split::Gold14a => todo!("Gold14a"),
        Split::Gold14b => todo!("Gold14b"),
        Split::Gold15 => todo!("Gold15"),
        Split::Gold16 => todo!("Gold16"),
        Split::Gold17a => todo!("Gold17a"),
        Split::Gold17b => todo!("Gold17b"),
        Split::Gold17c => todo!("Gold17c"),
        Split::GoldEnd => todo!("GoldEnd"),
